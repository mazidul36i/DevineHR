	...
	public boolean addDepartment(Department dept) throws DepartmentException {
		try (Connection conn = DBUtil.provideConnection()) {
			...
			if (x > 0) {
				...
				throw new DepartmentException("Failed to insert new department..!");
	...
	public boolean deleteDepartment(int deptId) throws DepartmentException {
		try (Connection conn = DBUtil.provideConnection()) {
			...
			if (x > 0) {
				...
				throw new DepartmentException("Failed to delete department with ID " + deptId + "!");
	...
	public boolean changeDeptName(int deptId, String newName) throws DepartmentException {
		try (Connection conn = DBUtil.provideConnection()) {
			...
			if (x > 0) {
				...
				throw new DepartmentException("Failed to update department name with ID " + deptId + "!");
